...
class ExportableTest extends TestCase
{
    ...
    {
        $this->expectException(\Analize\Excel\Exceptions\NoFilenameGivenException::class);
    ...
    {
        $this->expectException(\Analize\Excel\Exceptions\NoFilePathGivenException::class);
